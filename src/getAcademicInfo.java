public class getAcademicInfo extends ioHandler {
    public getAcademicInfo() {
        ...
        String[] computerResponses = { 
            ...
            "Great choice! I also happen to love that subject! Do you want me to continue?",
            ...
            "Alight, do you have another academic interest, if so, which one?", 
        };
        ...
        String[][] coursesInfoSenior = {
            ...
            { "Participation in Goverment, ", "Economics, ", "AP U.S. Government and Politics, ", "Macro/MicroEconomics, ", "Criminology, ", "Constitutional Law,", "Law Internship.", "" }, 
            { "Chinese IV, ", "French IV, ", "Spanish IV, ", "German IV, ", "AP Spanish. ", "", "", "", "", "" },
            { "Cyber Security. ", "", "", "", "", "", "", "" } 
        };
        ...
        for (int i = 0; i < 7; i++) {
            ...
            case 0:
                ...
                if (input.indexOf("math") >= 0 || input.indexOf("algebra") >= 0 || input.indexOf("trigonometry") >= 0 || input.indexOf("geometry") >= 0) {
                    ...
                    subject = 1;
                } else if (input.indexOf("computer science") >= 0 || input.indexOf("computer") >= 0 || input.indexOf("cs") >= 0) {
                    subject = 5;
                } else if (input.indexOf("global") >= 0 || input.indexOf("history") >= 0 || input.indexOf("social studies") >= 0 || input.indexOf("economics") >= 0) {
                    subject = 3;
            ...
            case 2:
                ...
                output("Would you like to know more?", 3);
                break;
            ...
            case 3:
                ...
                output("Would you like to know more?", 0);
                break;
            ...
            case 5:
                ...
                output("Would you like to continue?", 0);
                break;
            ...
            case 6:
                ...
                if (input.indexOf("math") >= 0 || input.indexOf("algebra") >= 0 || input.indexOf("trigonometry") >= 0
                    ...
                    subject = 2;
                        ...
                        || input.indexOf("social studies") >= 0 || input.indexOf("economics") >= 0) {
                    looped++;
                    i = 0;
                    subject = 3;
