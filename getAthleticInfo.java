...
public class getAthleticInfo extends ioHandler {
	...
	public getAthleticInfo() {
		...
		if (response.indexOf("soccer") >= 0) {
			...
			System.out.println(
					"So do you want to know more about our awesome Coaches? or hear about some team statistics?  \n Personally I think we have some great coaches"); //Ask what they want to know about
			...
			if (response.indexOf("coach") >= 0) {
				...
				System.out.println(
						"The coaches of Cardozo's Soccer Team are: Coach Richard Parascos Of The Boys Soccer Varsity Team and Coach Alyssa Rocco Of The Girls Soccer Varsity Team. They're both really great coaches o don't underestimate our soccer team!");
